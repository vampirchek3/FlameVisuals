-- LocalScript: FlameVisuals Client (Darker Watermark)
...
watermarkFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 12) -- Сделано темнее (было 15, 15, 20)
watermarkFrame.BackgroundTransparency = 0.15 -- Чуть менее прозрачный, чтобы глубина цвета лучше чувствовалась
...
wmStroke.Color = Color3.fromRGB(25, 25, 35) -- Рамка тоже стала темнее
...
wmStats.TextColor3 = Color3.fromRGB(160, 160, 175) -- Чуть приглушенный цвет текста статов для гармонии с темным фоном
wmStats.TextSize = 14
...
--------------------------------------------------------------------------------
-- 9. UTILITIES TAB (ВКЛАДКА УТИЛИТ)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- 10. CONFIGS TAB (ВКЛАДКА КОНФИГУРАЦИЙ)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- ПРОВЕРКА AUTOLOAD ПРИ СТАРТЕ СКРИПТА
--------------------------------------------------------------------------------
task.spawn(function()
    task.wait(0.2)
