...
local function startMainScript()
    ...
    cardReferences.ESP = createModuleCard(tabs["Visuals"], "ESP", t("desc_rmb_settings"), ESPConfig.Enabled, function(v)
        ...
        header.Size = UDim2.new(1, 0, 0, 18)
        header.BackgroundTransparency = 1
        header.Text = t("hdr_esp_settings")
        header.TextColor3 = Color3.fromRGB(140, 140, 160)
        header.TextSize = 12
        header.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold)
        header.ZIndex = 101
        ...
        addToggle(t("esp_boxes"), ESPConfig.Boxes, function(v) ESPConfig.Boxes = v end)
        addToggle(t("esp_names"), ESPConfig.Names, function(v) ESPConfig.Names = v end)
        addToggle(t("esp_health"), ESPConfig.Health, function(v) ESPConfig.Health = v end)
        addToggle(t("esp_skeleton"), ESPConfig.Skeleton, function(v) ESPConfig.Skeleton = v end)
    ...
    if configsTab then
        ...
        local function loadConfig(name)
            ...
            if data.ESP then
                ...
                ESPConfig.Boxes = data.ESP.Boxes or true
                ESPConfig.Names = data.ESP.Names or true
                ESPConfig.Health = data.ESP.Health or true
